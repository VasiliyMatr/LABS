...
% choosen question topic
    \newcommand{\topic}{Фильтр Лио}
...
% page style setup (for running titles)
    \fancypagestyle{plain}{
        ...
        \fancyfoot[L]{\ifthenelse{\isodd{\thepage}}{\topic}{\thepage}}
        \fancyfoot[R]{\ifthenelse{\isodd{\thepage}}{\thepage}{\topic}}
    }
...
% there are no indents in paragraphs begining
...
\begin{document}
    ...
    % other files includes
        \include{2WoodsFilter}
        \include{3LyotsFilter}
