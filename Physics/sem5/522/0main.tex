...
% lab name
    \newcommand{\labname}{
        Изучение спектров атомов водорода и молекул йода
    }

% lab objective
    \newcommand{\labobj}{
        Произвести исследование спектральных закономерностей в оптических спектрах водорода и йода.
        По результатам измерений вычислить постоянную Ридберга для водорода и потенциал ионизации.
    }
