...
% lab name
    \newcommand{\labname}{
        Дифракция света на звуковой волне в жидкости
    }

% lab objective
    \newcommand{\labobj}{
        изучение дифракции света на синусоидальной акустической решетке и
...
% lab equipment
    \newcommand{\labequ}{
        ...
        кварцевый излучатель с микрометрическим винтом, генератор звуковой частоты, линза,
