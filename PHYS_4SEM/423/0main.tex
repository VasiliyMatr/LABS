...
% lab name
    \newcommand{\labname}{
        Интерферометер Релея
    }

% lab objective
    \newcommand{\labobj}{
        ознакомление с устройством и принципом действия интерферометра Релея и с его
        применением для измерения показателей преломления газов.
    }

% lab equipment
    \newcommand{\labequ}{
        технический интерферометр ИТР-1б светофильтр, баллон с углекислым газом,
