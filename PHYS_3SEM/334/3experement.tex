...
\noindentПараметры образца: \mth{L_{35} = 3,0} мм; \mth{l = 1,7} мм; \mth{a = 1,5} мм. \\

\noindentТогда удельная проводимость образца: \mth{\sigma = \frac{IL_{35}}{U_{35}al} = 7,07 \pm 0,03 \,\frac{1}{\texttt{Ом} \cdot \texttt{см}}}
...
\mth{n = (1.1 \pm 0.1) \cdot 10^{22} \texttt{м}^{-3}} \\ 
