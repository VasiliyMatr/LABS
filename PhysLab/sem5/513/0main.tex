...
% lab objective
    \newcommand{\labobj}{
        Исследовать рассеяние электронов на атомах инертного газа; Рассчитать размер электронной оболочки атома; Оценить глубину потенциальной ямы и потенциал ионизации газа, заполняющего лампу.
    }
